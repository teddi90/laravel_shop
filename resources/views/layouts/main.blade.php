...
<head>
    ...
    <link href="{{asset('adminlte/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.css')}}" rel="stylesheet">
    <!-- jQuery -->
...
<div class="wrapper">
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2021-{{now()->year}} <a href="https://adminlte.io">Магазин</a>.</strong>
        Всі права захищені.
    </footer>
